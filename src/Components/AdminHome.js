      ...
      <div class="col">
        <div class="card h-100 shadow rounded float-start">
          ...
          <div class="card-body">
            ...
            <Link to="/addSpec" className="btn btn-primary stretched-link mx-1 shadow" style={{ borderRadius: '12px', backgroundColor: '#00ADEF', borderColor: '#00ADEF' }}>Add Specialist</Link>
