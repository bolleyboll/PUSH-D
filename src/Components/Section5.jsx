...
const Section5 = () => {
  const disable = () => {
    document.getElementById(sessionStorage.getItem("nOfSec5")).disabled = false;
  };
    ...
    <Container>
          <div className="app_section mb-5">
            <div style={{ marginLeft: "5%", marginRight: "5%" }}>
              <Fragment>
                <ToastContainer />
                <h1 className="text-center my-3 fs-3">Section-5</h1>
                <Form onSubmit={handleForm}>
                  ...
                  <Link to={sessionStorage.getItem("nextOfSec5")}>
                <Button
                    type="button"
                    color="success"
                    onClick={disable}
